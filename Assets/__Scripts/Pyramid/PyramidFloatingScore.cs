...
public class PyramidFloatingScore : MonoBehaviour
{
	...
	public void Init(List<Vector2> ePts, float eTimeS = 0, float eTimeD = 1)
	{
		...
		rectTrans.anchoredPosition = new Vector2(0, 152);
		...
		state = PFSState.pre; // Set it to the pre state, ready to start moving
	}
	...
	void Update()
	{
		...
		else
		{
			...
			if (fontSizes != null && fontSizes.Count > 0)
			{
				...
				// ...then adjust the fontSize of this Text on the GUI
